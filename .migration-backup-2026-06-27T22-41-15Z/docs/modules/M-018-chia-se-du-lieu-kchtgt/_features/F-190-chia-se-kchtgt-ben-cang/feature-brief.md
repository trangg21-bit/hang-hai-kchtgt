---
id: F-190
name: Chia se KCHTGT Ben cang
slug: chia-se-kchtgt-ben-cang
module-id: M-018
status: proposed
...
- API endpoint publish dữ liệu bến cảng lên Trục LGSP
...
| Role | Permissions |
|------|-------------|
| Khách truy cập (Public) | Xem thông tin bến cảng công khai |
| Nhân viên quản lý hạ tầng | Tạo, cập nhật, xóa thông tin bến cảng |
...
- **BenCang**: id, maBen, tenBen, tinhThanh, quanHuyen, xaPhuong, toaDo, dienTich, congSuatTieNhan, loaiTauChoPhep, tinhTrangHoatDong, createdAt, updatedAt

## Business Rules

1. Dữ liệu bến cảng chỉ được chia sẻ sau khi đã được kiểm tra tính hợp lệ (validation) về định dạng và nội dung
...
- Unit test: kiểm tra các hàm chuyển đổi dữ liệu bến cảng sang schema LGSP
