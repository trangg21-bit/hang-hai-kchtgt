...
priority: medium
created: "2026-07-01T04:08:45Z"
last-updated: "2026-07-01T04:08:45Z"
locked-fields: []
consumed_by_modules: []
---
...
6. Sau khi click "Tạo mới" và form hợp lệ, hệ thống gọi `POST /api/v1/vung-nuoc`; sau khi tạo thành công, hiển thị toast "Tạo mới vùng nước thành công — chờ phê duyệt" và redirect về trang Danh sách Vùng nước (F-088).
...
- Chỉnh sửa vùng nước đã tồn tại (thuộc F-091)
