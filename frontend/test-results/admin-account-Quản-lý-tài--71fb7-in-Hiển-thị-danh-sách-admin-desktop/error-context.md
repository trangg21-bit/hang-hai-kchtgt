...
```yaml
- generic [ref=e3]:
  - generic [ref=e4]: "[plugin:vite:oxc] Transform failed with 1 error: [PARSE_ERROR] Invalid Unicode escape sequence ╭─[ src/pages/admins/AdminList.tsx:149:19 ] │ 149 │ content: \\Bạn có chắc chắn muốn xóa \"\\\"? Hành động này không thể hoàn tác.\\, │ ┬ │ ╰── ─────╯"
  - generic [ref=e5]: C:/Users/trangtt1/hang-hai-kchtgt/frontend/src/pages/admins/AdminList.tsx
