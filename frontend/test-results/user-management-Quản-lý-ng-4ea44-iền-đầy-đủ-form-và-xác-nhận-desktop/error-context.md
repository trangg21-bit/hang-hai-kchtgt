...
- Name: user-management.spec.ts >> Quản lý người dùng (User CRUD) >> Tạo mới người dùng — điền đầy đủ form và xác nhận
- Location: e2e\user-management.spec.ts:41:3
...
```yaml
- generic [ref=e3]:
  - generic [ref=e4]: "[plugin:vite:oxc] Transform failed with 1 error: [PARSE_ERROR] Invalid Unicode escape sequence ╭─[ src/pages/groups/GroupList.tsx:145:19 ] │ 145 │ content: \\Bạn có chắc chắn muốn xóa nhóm \"\\\"? Hành động này không thể hoàn tác.\\, │ ┬ │ ╰── ─────╯"
  - generic [ref=e5]: C:/Users/trangtt1/hang-hai-kchtgt/frontend/src/pages/groups/GroupList.tsx
