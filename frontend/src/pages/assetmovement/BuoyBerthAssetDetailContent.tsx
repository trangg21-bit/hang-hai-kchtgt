...
export interface BuoyBerthAssetDetailContentProps {
  open: boolean;
  selectedRecord?: BuoyBerthAsset;
  onClose: () => void;
  orgName: Map<string, string>;
  buoyBerthMap: Map<string, BuoyBerth>;
...
export default function BuoyBerthAssetDetailContent({
  open,
  selectedRecord: r,
  onClose,
  orgName,
  ...
  increaseRows,
  decreaseRows,
}: BuoyBerthAssetDetailContentProps) {
        ...
        sections: [
          {
            ...
            fields: [
              ...
              },
              {
                label: 'Mã bến phao',
                value: (rec) =>
                  buoyBerthMap.get(rec.buoyBerthId || '')?.buoyBerthCode || '—',
              },
              {
                label: 'Tên bến phao',
                value: (rec) =>
                  buoyBerthMap.get(rec.buoyBerthId || '')?.buoyBerthName || '—',
              },
              {
                name: 'assetType',
                label: 'Loại tài sản',
                ...
                <div key={row.id || index} style={sectionBoxStyle}>
                  <div style={sectionHeaderStyle}>
                    <div style={sectionTitleStyle}>
                      ...
                      <span>
                        Lần {index + 1} — {fmtDateTime(row.updatedAt || row.createdAt)}
                      </span>
                    </div>
                  </div>
  ...
  return (
    <DynamicViewSidebar<BuoyBerthAsset>
      open={open}
