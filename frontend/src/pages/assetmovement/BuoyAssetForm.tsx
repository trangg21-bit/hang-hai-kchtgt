        ...
        sections: [
          {
            ...
            fields: [
              ...
              { name: 'quantity', label: 'Số lượng', type: FormFieldType.Number, min: 0, maxLength: 5, placeholder: '0', required: true, rules: [{ required: true, message: 'Số lượng là bắt buộc' }], colSpan: 6 },
              ...
              { name: 'landArea', label: 'Diện tích (đất, sàn sử dụng: m²)', type: FormFieldType.Number, min: 0, maxLength: 20, placeholder: '0.00' },
              { name: 'floorArea', label: 'Diện tích sàn sử dụng (m²)', type: FormFieldType.Number, min: 0, maxLength: 20, placeholder: '0.00' },
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            icon: <SlidersOutlined />,
            fields: [
              { name: 'originalValue', label: 'Nguyên giá (VNĐ)', type: FormFieldType.Number, min: 0, maxLength: 20, placeholder: '0' },
              { name: 'depreciationRate', label: 'Tỷ lệ hao mòn/Khấu hao (%)', type: FormFieldType.Number, min: 0, max: 100, maxLength: 5, placeholder: '0.00' },
              { name: 'accumulatedDepreciation', label: 'Khấu hao lũy kế (VNĐ)', type: FormFieldType.Number, min: 0, maxLength: 20, placeholder: '0' },
              {
                name: 'remainingValue',
