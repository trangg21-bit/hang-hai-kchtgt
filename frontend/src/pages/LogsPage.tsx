...
const RESOURCE_MAP: Record<string, string> = {
  ...
  VTSASSIST: 'hệ thống phụ trợ VTS',
  ANCHORAGE: 'khu neo đậu',
  ANCHORAGE_AREA: 'khu neo đậu',
  ANCHORAGEAREA: 'khu neo đậu',
  TRANSFER_AREA: 'khu chuyển tải',
  TRANSFERAREA: 'khu chuyển tải',
  STORM_SHELTER: 'khu tránh trú bão',
  STORMSHELTER: 'khu tránh trú bão',
  BUOY_BERTH: 'bến phao',
  BUOYBERTH: 'bến phao',
  TRANSMISSION: 'hệ thống truyền dẫn',
  SHIP_REPAIR_YARD: 'cơ sở sửa chữa, đóng tàu',
  SHIPREPAIRYARD: 'cơ sở sửa chữa, đóng tàu',
  AIS_SYSTEM: 'hệ thống AIS',
  AISSYSTEM: 'hệ thống AIS',
  CCTV: 'hệ thống CCTV',
  STATIONS: 'nhà trạm',
  COASTAL_STATION_INMARSAT: 'đài thông tin vệ tinh mặt đất Inmarsat Hải Phòng',
  COASTAL_STATION_COSPAS_SARSAT: 'đài Thông tin vệ tinh mặt đất Cospas-Sarsat Việt Nam',
  COASTAL_STATION_LRIT: 'đài thông tin nhận dạng và truy theo tầm xa (LRIT)',
  COASTALSTATIONLRIT: 'đài thông tin nhận dạng và truy theo tầm xa (LRIT)',
  COASTAL_STATION_HAIPHONG: 'đài TTXLTT Hà Nội / Hải Phòng',
  COASTALSTATIONHAIPHONG: 'đài TTXLTT Hà Nội / Hải Phòng',
