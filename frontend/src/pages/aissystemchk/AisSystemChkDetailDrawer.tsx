...
interface AisSystemChkDetailDrawerProps {
  visible: boolean;
...
export const AisSystemChkDetailDrawer: React.FC<AisSystemChkDetailDrawerProps> = ({
  visible,
  item,
  onClose,
  onEdit,
...
export default AisSystemChkDetailDrawer;
