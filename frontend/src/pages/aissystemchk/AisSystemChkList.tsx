...
import { AisSystemChkFormModal } from './AisSystemChkFormModal';
import { AisSystemChkDetailDrawer } from './AisSystemChkDetailDrawer';
...
export const AisSystemChkList: React.FC = () => {
...
export default AisSystemChkList;
