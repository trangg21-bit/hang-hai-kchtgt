      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
        <Col xs={24} md={16}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            ...
            <ReactECharts option={cargoOption} style={{ height: 320 }} notMerge lazyUpdate />
          </div>
        </Col>
        <Col xs={24} md={8}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            <h4 style={CHART_TITLE_STYLE}>Cơ cấu phương tiện<MockBadge show={blockStates.donutPhuongTien?.isMockFallback} /></h4>
            <ReactECharts option={donut1Option} style={{ height: 320 }} notMerge lazyUpdate />
          </div>
        </Col>
      </Row>

      {/* Row 3 — Ring KCHT + Radar KCHT (Tối ưu 2 cột 50% - 50% chuẩn thiết kế và thoáng nhãn 28 trục) */}
      <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
        <Col xs={24} md={12}>
          <div style={{ ...CARD_BASE, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <ReactECharts option={ringOption} style={{ height: 360 }} notMerge lazyUpdate />
          </div>
        </Col>
        <Col xs={24} md={12}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            ...
            {radarData.length > 0 ? (
              ...
              <div style={{ height: 360, display: 'flex', alignItems: 'center', justifyContent: 'center', color: ink2 }}>Không có dữ liệu</div>
            )}
          </div>
        </Col>
      </Row>

      {/* Row 4 — Polar passenger + H-Bar phê duyệt + Donut phê duyệt */}
      <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
        <Col xs={24} md={8}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            <h4 style={CHART_TITLE_STYLE}>Lượt hành khách qua cảng<MockBadge show={blockStates.linePassenger?.isMockFallback} /></h4>
            <ReactECharts option={polarOption} style={{ height: 320 }} notMerge lazyUpdate />
          </div>
        </Col>
        <Col xs={24} md={8}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            <h4 style={CHART_TITLE_STYLE}>Phê duyệt theo hạng mục<MockBadge show={blockStates.hBarApproval?.isMockFallback} /></h4>
            <ReactECharts option={hBarOption} style={{ height: 320 }} notMerge lazyUpdate />
          </div>
        </Col>
        <Col xs={24} md={8}>
          <div style={{ ...CARD_BASE, height: '100%' }}>
            <h4 style={CHART_TITLE_STYLE}>Trạng thái phê duyệt<MockBadge show={blockStates.donutPheDuyet?.isMockFallback} /></h4>
            <ReactECharts option={donut2Option} style={{ height: 320 }} notMerge lazyUpdate />
          </div>
        </Col>
      </Row>
...
// ============================================================
// DashboardPage — wraps everything in FilterProvider
// ============================================================
