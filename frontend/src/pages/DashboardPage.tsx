...
export const INFRA_DATA: InfraRow[] = [
  ...
  { sequenceNo: 19, code: 'ais_system', type: 'Hệ thống AIS', total: 45, pending: 4, operating: 40, suspended: 1 },
  ...
  { sequenceNo: 25, code: 'coastal_station_inmarsat', type: 'Đài thông tin vệ tinh mặt đất Inmarsat Hải Phòng', total: 4, pending: 0, operating: 4, suspended: 0 },
  { sequenceNo: 26, code: 'coastal_station_lrit', type: 'Đài thông tin nhận dạng và truy theo tầm xa (LRIT)', total: 2, pending: 0, operating: 2, suspended: 0 },
  { sequenceNo: 27, code: 'coastal_station_cospas_sarsat', type: 'Đài Thông tin vệ tinh mặt đất Cospas-Sarsat Việt Nam', total: 3, pending: 0, operating: 3, suspended: 0 },
...
const KCHT_LABEL_ROUTES: Record<string, string> = {
  ...
  'Hệ thống VHF': '/vhf',
  'Đài thông tin vệ tinh mặt đất Inmarsat Hải Phòng': '/station/inmarsat',
  'Đài Thông tin vệ tinh Inmarsat': '/station/inmarsat',
  'Đài thông tin nhận dạng và truy theo tầm xa (LRIT)': '/station/lrit',
  'Đài Nhận dạng và truy theo tầm xa (LRIT)': '/station/lrit',
  'Đài Thông tin vệ tinh mặt đất Cospas-Sarsat Việt Nam': '/station/cospas-sarsat',
