...
const PierForm = forwardRef<any, PierFormProps>(({ form, id, onFinish, onSubmittingChange }, ref) => {
  ...
  const tabItems = [
    ...
    // Tab 2: Thông tin phương án, công bố & phạm vi khu nước
    { key: 'announcement', label: 'Thông tin phương án, công bố & phạm vi khu nước', children: (<div style={drawerTabContentStyle}>
      ...
      <Row gutter={[24, 0]}><Col span={12}><Form.Item name="investmentAgreementDoc" {...labelProps('Văn bản thỏa thuận đầu tư xây dựng')} style={{ marginBottom: spaceFormField }}><Input placeholder="Nhập văn bản thỏa thuận" maxLength={2000} showCount style={inputStyle} /></Form.Item></Col><Col span={12}><Form.Item name="waterAreaNeutralScope" {...labelProps('Phạm vi khu nước neo buộc tàu')} style={{ marginBottom: spaceFormField }}><Input placeholder="Nhập phạm vi khu nước" maxLength={2000} showCount style={inputStyle} /></Form.Item></Col></Row>
    </div>) },
