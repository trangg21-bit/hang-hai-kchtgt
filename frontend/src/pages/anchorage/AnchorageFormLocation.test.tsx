...
describe('Anchorage — Location & GIS Coordinate Handling', () => {
  it('TC-ANC-01: parseGisCoordinates handles SRID=4326; prefix with POLYGON correctly', () => {
  ...
  it('TC-ANC-02: parseGisCoordinates handles SRID=4326; prefix with POINT correctly', () => {
  ...
  it('TC-ANC-03: parseGisCoordinates handles SRID=4326; prefix with LINESTRING correctly', () => {
  ...
  it('TC-ANC-04: parseWktToCoordinates and serializeCoordinatesToWkt work reciprocally for POLYGON', () => {
  ...
  it('TC-ANC-05: Fallback WKT preservation logic retains initial coordinates during edit', () => {
    const isEdit = true;
    ...
    const vals = {
      ...
      anchorageName: 'Khu neo Hải Phòng (sửa tên)',
    };
    ...
    const payload = {
      anchorageName: vals.anchorageName,
  ...
  it('TC-ANC-06: Intentionally clearing geometryType clears location in payload', () => {
    const isEdit = true;
