...
import type { RadarStationAsset, RadarStationAssetPayload } from '../../services/radarasset/types';
...
export default function RadarStationAssetForm({
        ...
        sections: [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                rules: [{ required: true, message: 'Mã trạm radar là bắt buộc' }],
                colSpan: 12,
              },
            ],
          },
  ...
  }, [attachments, onDeleteAttachment, onDownloadAttachment, onUploadAttachment, organizations, radarStations, selected?.id]);
