...
const KCHT_TREE: KchtTypeNode[] = [
  {
    ...
    children: [
      ...
      { key: '/buoy-berth', name: 'Bến phao', level: 'C1' },
  ...
  { key: '/navigation-channel', name: 'Luồng hàng hải', level: 'C0', icon: <CompassOutlined /> },
  { key: '/vhf', name: 'Hệ thống thông tin liên lạc VHF', level: 'C0', icon: <RadioIcon /> },
  { key: '/ship-repair-yard', name: 'Cơ sở sửa chữa, đóng tàu', level: 'C0', icon: <ToolOutlined /> },
  { key: '/beacon-stations', name: 'Đèn biển và nhà trạm gắn với Đèn biển', level: 'C0', icon: <FireOutlined /> },
  {
    key: '/buoy-station',
    name: 'Nhà trạm vận hành Phao, tiêu',
    level: 'C0',
    icon: <HomeOutlined />,
    children: [{ key: '/buoys', name: 'Phao, tiêu', level: 'C1' }],
  },
  { key: '/dike-revetment', name: 'Đê chắn sóng, đê chắn cát, kè hướng dòng, kè bảo vệ bờ', level: 'C0', icon: <BlockOutlined /> },
  {
    key: '/vts-system',
    name: 'Hệ thống VTS',
    level: 'C0',
    icon: <ApiOutlined />,
    children: [
      { key: '/vts-operation-center', name: 'Trung tâm điều hành VTS', level: 'C1' },
      { key: '/radar-station', name: 'Trạm radar', level: 'C1' },
      { key: '/ais-system', name: 'Hệ thống AIS', level: 'C1' },
      { key: '/scada', name: 'Hệ thống SCADA', level: 'C1' },
      { key: '/transmission', name: 'Hệ thống truyền dẫn', level: 'C1' },
      { key: '/vts-assist', name: 'Hệ thống phụ trợ VTS', level: 'C1' },
      { key: '/cctv', name: 'Hệ thống CCTV', level: 'C1' },
    ],
  },
  {
    key: 'kcht-vienthong',
    name: 'Hệ thống thông tin duyên hải Việt Nam',
    note: 'gắn lỏng',
    level: 'C0',
    icon: <ApartmentOutlined />,
    children: [
      { key: '/dai-ttdh', name: 'Đài TTDH', level: 'C1' },
      { key: '/station/inmarsat', name: 'Đài thông tin vệ tinh mặt đất Inmarsat Hải Phòng', level: 'C1' },
      { key: '/station/cospas-sarsat', name: 'Đài Thông tin vệ tinh mặt đất Cospas-Sarsat Việt Nam', level: 'C1' },
      { key: '/station/lrit', name: 'Đài thông tin nhận dạng và truy theo tầm xa (LRIT)', level: 'C1' },
...
const NODE_ICONS: Record<string, ReactNode> = {
  ...
  'kcht-vienthong': <ApartmentOutlined />,
...
const ROUTE_PERMISSIONS: Record<string, string | string[]> = {
  ...
  '/ship-repair-yard': ['shiprepairyard:read', 'shiprepairfacility:read', 'shiprepair:read', 'port:read', 'data:read'],
  '/vts-system': 'vts:read',
  ...
  'kcht-vienthong': ['daittdh:read', 'coastalstation:read', 'specialstation:read', 'data:read'],
