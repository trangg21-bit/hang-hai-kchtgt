...
const ROUTE_PERMISSIONS: Record<string, string | string[]> = {
  ...
  '/asset/berth': ['infraasset:manage', 'infraasset:read', 'port:read', 'berth:read', 'data:read'],
  '/asset/ttdh': ['infraasset:manage', 'infraasset:read', 'daittdh:read', 'coastalstation:read', 'data:read'],
  '/asset/inmarsat': ['infraasset:manage', 'infraasset:read', 'specialstation:read', 'coastalstationinmarsat:read', 'coastalstation:read', 'data:read'],
  '/asset/cospas-sarsat': ['infraasset:manage', 'infraasset:read', 'specialstation:read', 'coastalstationcospassarsat:read', 'coastalstation:read', 'data:read'],
  '/asset/lrit': ['infraasset:manage', 'infraasset:read', 'specialstation:read', 'coastalstationlrit:read', 'coastalstation:read', 'data:read'],
  '/asset/ttxltt': ['infraasset:manage', 'infraasset:read', 'specialstation:read', 'coastalstationhaiphong:read', 'coastalstation:read', 'data:read'],
};
