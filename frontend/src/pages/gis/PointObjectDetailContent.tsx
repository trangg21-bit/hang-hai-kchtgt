...
export const PointObjectDetailContent: React.FC<PointObjectDetailContentProps> = ({
  ...
  return (
    <div className="point-detail-content-wrapper">
      <style>{`
        .point-detail-content-wrapper {
        ...
        .point-detail-content-wrapper,
        .point-detail-content-wrapper .chk-detail-label,
        .point-detail-content-wrapper .chk-detail-value {
          font-size: 13.5px !important;
        }

        .point-detail-content-wrapper .chk-detail-grid {
        ...
        .point-detail-content-wrapper .chk-detail-row {
        ...
        .point-detail-content-wrapper .chk-detail-row:last-child {
          border-bottom: none !important;
        }

        .point-detail-content-wrapper .chk-detail-row--full {
        ...
        .point-detail-content-wrapper .chk-detail-label::after {
          content: ':' !important;
      ...
      <div style={sectionBoxStyle}>
        ...
        <div className="chk-detail-grid">
          <div className="chk-detail-row">
            <span className="chk-detail-label">Mã đối tượng điểm</span>
          ...
          <div className="chk-detail-row chk-detail-row--full">
            <span className="chk-detail-label">Tên đối tượng điểm</span>
          ...
          <div className="chk-detail-row">
            ...
            <span className="chk-detail-value">Đối tượng điểm (Point)</span>
          </div>
