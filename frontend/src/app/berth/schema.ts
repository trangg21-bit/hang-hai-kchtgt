...
export const listFiltersSchema = z.object({
  ...
  portStatus: z.enum(["NHAP", "CHO_PHE_DUYET", "DA_PHE_DUYET", "TU_CHOI", "TAM_NGUNG"]).optional(),
...
export const createSchema = z.object({
  ...
  orgUnitId: z.string().uuid().optional().or(z.literal("")),
  waterway: z.string().max(255, "Tuyến đường thủy tối đa 255 ký tự").optional().or(z.literal("")),
  ...
  channelDepth: z.coerce.number().optional().or(z.nan()),
  ...
  locationCode: z.string().max(100).optional().or(z.literal("")),
  ...
  operator: z.string().max(255, "Đơn vị khai thác tối đa 255 ký tự").optional().or(z.literal("")),
  ...
  totalArea: z.coerce.number().optional().or(z.nan()),
  nangLucThongQuaThietKe: z.coerce.number().optional().or(z.nan()),
  designThroughput: z.coerce.number().optional().or(z.nan()),
  nangLucThongQuaHienTrang: z.coerce.number().optional().or(z.nan()),
  currentThroughput: z.coerce.number().optional().or(z.nan()),
  coTauTiepNhanLonNhat: z.coerce.number().optional().or(z.nan()),
  maxVesselSize: z.coerce.number().optional().or(z.nan()),
  quyHoachNangLucThongQua: z.coerce.number().optional().or(z.nan()),
  plannedThroughput: z.coerce.number().optional().or(z.nan()),
  sanLuongHangHoaNamGanNhat: z.coerce.number().optional().or(z.nan()),
  latestCargoVolume: z.coerce.number().optional().or(z.nan()),
  thoiDiemCongBoMo: z.string().optional().or(z.literal("")),
  openingAnnouncementDate: z.string().optional().or(z.literal("")),
  openingDecision: z.string().max(500, "Quyết định công bố tối đa 500 ký tự").optional().or(z.literal("")),
  quyetDinhCongBo: z.string().max(500, "Quyết định công bố tối đa 500 ký tự").optional().or(z.literal("")),
  investmentAgreement: z.string().max(2000, "Văn bản thỏa thuận đầu tư tối đa 2000 ký tự").optional().or(z.literal("")),
