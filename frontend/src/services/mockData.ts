...
export const MOCK_GROUPS = [
  ...
  { id: 'grp-005', name: 'Nhóm Cảng vụ Hải Phòng', code: 'GRP_HPV', description: 'Nhóm cán bộ Cảng vụ Hàng hải Hải Phòng', permissions: ['cangbien:read', 'bencang:read', 'navigationchannel:read', 'data:read'], memberCount: 12, status: 'active' as const, createdAt: '2025-04-01T00:00:00Z', updatedAt: '2026-06-15T00:00:00Z' },
  ...
  { id: 'grp-007', name: 'Nhóm Khu nước & VTS', code: 'GRP_VTS', description: 'Nhóm quản lý luồng, VTS, đê kè', permissions: ['navigationchannel:read', 'dikerevetment:read', 'vts:read', 'tramradar:read', 'data:read'], memberCount: 7, status: 'active' as const, createdAt: '2025-06-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
