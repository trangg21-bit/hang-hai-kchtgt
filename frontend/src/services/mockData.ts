...
export const MOCK_GROUPS = [
  ...
  { id: 'grp-007', name: 'Nhóm Khu nước & VTS', code: 'GRP_VTS', description: 'Nhóm quản lý luồng, VTS, đê kè', permissions: ['navigationchannel:read', 'deke:read', 'vts:read', 'tramradar:read', 'data:read'], memberCount: 7, status: 'active' as const, createdAt: '2025-06-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
