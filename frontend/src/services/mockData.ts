...
export const MOCK_ORGANIZATIONS = [
  ...
  { id: 'a0000000-0000-4000-8000-000000000011', name: 'Phòng Quản lý KCHTGT Hàng Hải', code: 'P_KCHT', parentId: 'a0000000-0000-4000-8000-000000000001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'SUB_DEPARTMENT' as const, description: 'Phòng chuyên trách quản lý kết cấu hạ tầng giao thông hàng hải', address: 'Số 8 Phạm Hùng, Hà Nội', phone: '024.37684567', contactPerson: 'Trần Thị Mai', status: 'approved' as const, childCount: 0, createdAt: '2025-09-01T00:00:00Z', updatedAt: '2026-06-10T00:00:00Z' },
  { id: 'a0000000-0000-4000-8000-000000000012', name: 'Trung tâm Phối hợp Tìm kiếm Cứu nạn Hàng hải', code: 'TT_TKCN', parentId: 'a0000000-0000-4000-8000-000000000001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'GENERAL_DEPARTMENT' as const, description: 'Trung tâm phối hợp tìm kiếm cứu nạn trên biển', address: 'Số 1 Nguyễn Cơ Thạch, Hà Nội', phone: '024.37891234', contactPerson: 'Phạm Ngọc Hoài', status: 'rejected' as const, childCount: 0, createdAt: '2025-10-01T00:00:00Z', updatedAt: '2026-03-01T00:00:00Z' },
  // Level 3 — Đại diện
  { id: 'org-013', name: 'Đại diện Cảng vụ Hải Phòng tại Đình Vũ', code: 'DD_CVHP_DV', parentId: 'a0000000-0000-4000-8000-000000000002', parentOrgName: 'Cảng vụ Hàng hải Hải Phòng', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại khu vực Đình Vũ', address: 'KCN Đình Vũ, Hải Phòng', phone: '0225.3768111', contactPerson: 'Hoàng Minh Đức', status: 'approved' as const, childCount: 0, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-06-15T00:00:00Z' },
  { id: 'org-014', name: 'Đại diện Cảng vụ Quảng Ninh tại Cái Lân', code: 'DD_CVQN_CL', parentId: 'a0000000-0000-4000-8000-000000000003', parentOrgName: 'Cảng vụ Hàng hải Quảng Ninh', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cảng Cái Lân', address: 'Cảng Cái Lân, Hạ Long, Quảng Ninh', phone: '0203.3825999', contactPerson: 'Lê Văn Hải', status: 'approved' as const, childCount: 0, createdAt: '2026-02-01T00:00:00Z', updatedAt: '2026-06-20T00:00:00Z' },
  { id: 'org-015', name: 'Đại diện Cảng vụ TP.HCM tại Cát Lái', code: 'DD_CVHCM_CL', parentId: 'a0000000-0000-4000-8000-000000000004', parentOrgName: 'Cảng vụ Hàng hải TP. Hồ Chí Minh', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cảng Cát Lái', address: 'Cảng Cát Lái, TP. Thủ Đức, TP.HCM', phone: '028.38221999', contactPerson: 'Trần Thanh Tùng', status: 'pending' as const, childCount: 0, createdAt: '2026-03-01T00:00:00Z', updatedAt: '2026-07-01T00:00:00Z' },
  { id: 'org-016', name: 'Đại diện Xí nghiệp BĐAT Đông Bắc Bộ tại Móng Cái', code: 'DD_XNDBB_MC', parentId: 'a0000000-0000-4000-8000-000000000010', parentOrgName: 'Xí nghiệp Bảo đảm An toàn Hàng hải Đông Bắc Bộ', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cửa khẩu Móng Cái', address: 'Số 5 Trần Phú, Móng Cái, Quảng Ninh', phone: '0203.3888123', contactPerson: 'Nguyễn Thanh Hà', status: 'draft' as const, childCount: 0, createdAt: '2026-04-01T00:00:00Z', updatedAt: '2026-07-05T00:00:00Z' },
