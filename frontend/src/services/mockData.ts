...
export const MOCK_GROUPS = [
  ...
  { id: 'grp-005', name: 'Nhóm Cảng vụ Hải Phòng', code: 'GRP_HPV', description: 'Nhóm cán bộ Cảng vụ Hàng hải Hải Phòng', permissions: ['cangbien:read', 'bencang:read', 'luonghanghai:read', 'data:read'], memberCount: 12, status: 'active' as const, createdAt: '2025-04-01T00:00:00Z', updatedAt: '2026-06-15T00:00:00Z' },
  ...
  { id: 'grp-007', name: 'Nhóm Khu nước & VTS', code: 'GRP_VTS', description: 'Nhóm quản lý luồng, VTS, đê kè', permissions: ['luonghanghai:read', 'deke:read', 'vts:read', 'tramradar:read', 'data:read'], memberCount: 7, status: 'active' as const, createdAt: '2025-06-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
  ...
  { id: 'grp-009', name: 'Nhóm Kiểm kê tài sản', code: 'GRP_ASSET', description: 'Nhóm kiểm kê và quản lý biến động tài sản', permissions: ['asset:yeu-cau-tang', 'asset:yeu-cau-giam', 'asset:kiem-ke', 'asset:khai-thac', 'data:read'], memberCount: 9, status: 'active' as const, createdAt: '2025-08-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
...
export const MOCK_ORGANIZATIONS = [
  { id: 'org-001', name: 'Cục Hàng hải và Đường thủy Việt Nam', code: 'CUC_HH', parentId: undefined, parentOrgName: undefined, level: 1, type: 'CUC' as const, description: 'Cơ quan quản lý nhà nước về hàng hải', address: 'Số 8 Phạm Hùng, Hà Nội', phone: '024.37683111', contactPerson: 'Nguyễn Văn An', coefficient: 1.0, status: 'approved' as const, childCount: 3, createdAt: '2025-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
  { id: 'org-002', name: 'Cảng vụ Hàng hải Hải Phòng', code: 'CV_HP', parentId: 'org-001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'CANG_VU' as const, description: 'Cảng vụ quản lý khu vực Hải Phòng', address: 'Số 3 Lý Tự Trọng, Hải Phòng', phone: '0225.3822123', contactPerson: 'Lê Anh Tuấn', coefficient: 0.9, status: 'approved' as const, childCount: 0, createdAt: '2025-02-01T00:00:00Z', updatedAt: '2026-03-01T00:00:00Z' },
  { id: 'org-003', name: 'Cảng vụ Hàng hải Quảng Ninh', code: 'CV_QN', parentId: 'org-001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'CANG_VU' as const, description: 'Cảng vụ quản lý khu vực Quảng Ninh', address: 'Số 12 Trần Phú, Hạ Long, Quảng Ninh', phone: '0203.3825234', contactPerson: 'Trần Quốc Cường', coefficient: 0.85, status: 'approved' as const, childCount: 0, createdAt: '2025-02-15T00:00:00Z', updatedAt: '2026-04-01T00:00:00Z' },
  { id: 'org-004', name: 'Cảng vụ Hàng hải TP. Hồ Chí Minh', code: 'CV_HCM', parentId: 'org-001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'CANG_VU' as const, description: 'Cảng vụ quản lý khu vực TP. Hồ Chí Minh', address: 'Số 45 Nguyễn Tất Thành, TP. HCM', phone: '028.38221123', contactPerson: 'Bùi Văn Anh', coefficient: 0.95, status: 'approved' as const, childCount: 0, createdAt: '2025-03-01T00:00:00Z', updatedAt: '2026-05-01T00:00:00Z' },
  { id: 'org-005', name: 'Chi cục Hàng hải Miền Bắc', code: 'CC_MB', parentId: undefined, parentOrgName: undefined, level: 1, type: 'CHI_CUC' as const, description: 'Chi cục quản lý khu vực phía Bắc', address: 'Số 5 Ngô Quyền, Hà Nội', phone: '024.38262234', contactPerson: 'Phạm Đức Minh', coefficient: 0.8, status: 'approved' as const, childCount: 2, createdAt: '2025-04-01T00:00:00Z', updatedAt: '2026-02-01T00:00:00Z' },
  { id: 'org-006', name: 'Chi cục Hàng hải Miền Trung', code: 'CC_MT', parentId: undefined, parentOrgName: undefined, level: 1, type: 'CHI_CUC' as const, description: 'Chi cục quản lý khu vực miền Trung', address: 'Số 20 Bạch Đằng, Đà Nẵng', phone: '0236.3822334', contactPerson: 'Nguyễn Thị Hương', coefficient: 0.75, status: 'pending' as const, childCount: 0, createdAt: '2025-05-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
  { id: 'org-007', name: 'Đội Quản lý Đèn biển Hải Phòng', code: 'DL_DB_HP', parentId: 'org-005', parentOrgName: 'Chi cục Hàng hải Miền Bắc', level: 2, type: 'CANG_VU' as const, description: 'Đội quản lý hệ thống đèn biển Hải Phòng', address: 'Số 8 Trần Hưng Đạo, Hải Phòng', phone: '0225.3834456', contactPerson: 'Nguyễn Hồng Sơn', coefficient: 0.7, status: 'approved' as const, childCount: 0, createdAt: '2025-06-01T00:00:00Z', updatedAt: '2026-04-01T00:00:00Z' },
  { id: 'org-008', name: 'Đội Quản lý Phao tiêu Quảng Ninh', code: 'DL_PT_QN', parentId: 'org-005', parentOrgName: 'Chi cục Hàng hải Miền Bắc', level: 2, type: 'CANG_VU' as const, description: 'Đội quản lý hệ thống phao tiêu Quảng Ninh', address: 'Số 3 Cái Lân, Hạ Long', phone: '0203.3834567', contactPerson: 'Đỗ Thanh Phương', coefficient: 0.65, status: 'approved' as const, childCount: 0, createdAt: '2025-07-01T00:00:00Z', updatedAt: '2026-05-01T00:00:00Z' },
  { id: 'org-009', name: 'Tổng công ty Bảo đảm An toàn Hàng hải Miền Bắc', code: 'TCT_BDAT_MB', parentId: undefined, parentOrgName: undefined, level: 1, type: 'TCT' as const, description: 'Tổng công ty bảo đảm an toàn hàng hải khu vực phía Bắc', address: 'Số 15 Lê Thánh Tông, Hải Phòng', phone: '0225.3845678', contactPerson: 'Vũ Hoàng Quân', coefficient: 0.9, status: 'approved' as const, childCount: 1, createdAt: '2025-03-15T00:00:00Z', updatedAt: '2026-01-15T00:00:00Z' },
  { id: 'org-010', name: 'Xí nghiệp Bảo đảm An toàn Hàng hải Đông Bắc Bộ', code: 'XN_DBB', parentId: 'org-009', parentOrgName: 'Tổng công ty Bảo đảm An toàn Hàng hải Miền Bắc', level: 2, type: 'CANG_VU' as const, description: 'Xí nghiệp trực thuộc TCT BĐAT HH Miền Bắc', address: 'Số 25 Nguyễn Trãi, Hải Phòng', phone: '0225.3856789', contactPerson: 'Nguyễn Thùy Linh', coefficient: 0.6, status: 'draft' as const, childCount: 0, createdAt: '2025-08-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
  { id: 'org-011', name: 'Phòng Quản lý KCHTGT Hàng Hải', code: 'P_KCHT', parentId: 'org-001', parentOrgName: 'Cục Hàng hải và Đường thủy Việt Nam', level: 2, type: 'CHI_CUC' as const, description: 'Phòng chuyên trách quản lý kết cấu hạ tầng giao thông hàng hải', address: 'Số 8 Phạm Hùng, Hà Nội', phone: '024.37684567', contactPerson: 'Trần Thị Mai', coefficient: 0.95, status: 'approved' as const, childCount: 0, createdAt: '2025-09-01T00:00:00Z', updatedAt: '2026-06-10T00:00:00Z' },
  { id: 'org-012', name: 'Trung tâm Phối hợp Tìm kiếm Cứu nạn Hàng hải', code: 'TT_TKCN', parentId: undefined, parentOrgName: undefined, level: 1, type: 'TCT' as const, description: 'Trung tâm phối hợp tìm kiếm cứu nạn trên biển', address: 'Số 1 Nguyễn Cơ Thạch, Hà Nội', phone: '024.37891234', contactPerson: 'Phạm Ngọc Hoài', coefficient: 0.85, status: 'rejected' as const, childCount: 0, createdAt: '2025-10-01T00:00:00Z', updatedAt: '2026-03-01T00:00:00Z' },
];
