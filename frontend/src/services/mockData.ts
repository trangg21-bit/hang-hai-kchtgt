...
export const MOCK_ORGANIZATIONS = [
  ...
  { id: 'org-006', name: 'Chi cục Hàng hải Miền Trung', code: 'CC_MT', parentId: undefined, parentOrgName: undefined, level: 1, type: 'CHI_CUC' as const, description: 'Chi cục quản lý khu vực miền Trung', address: 'Số 20 Bạch Đằng, Đà Nẵng', phone: '0236.3822334', contactPerson: 'Nguyễn Thị Hương', status: 'pending' as const, childCount: 0, createdAt: '2025-05-01T00:00:00Z', updatedAt: '2026-06-01T00:00:00Z' },
  ...
  { id: 'org-012', name: 'Trung tâm Phối hợp Tìm kiếm Cứu nạn Hàng hải', code: 'TT_TKCN', parentId: undefined, parentOrgName: undefined, level: 1, type: 'TCT' as const, description: 'Trung tâm phối hợp tìm kiếm cứu nạn trên biển', address: 'Số 1 Nguyễn Cơ Thạch, Hà Nội', phone: '024.37891234', contactPerson: 'Phạm Ngọc Hoài', status: 'rejected' as const, childCount: 0, createdAt: '2025-10-01T00:00:00Z', updatedAt: '2026-03-01T00:00:00Z' },
];
