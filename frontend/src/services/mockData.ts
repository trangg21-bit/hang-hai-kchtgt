...
export const MOCK_GROUPS = [
  ...
  { id: 'grp-005', name: 'Nhóm Cảng vụ Hải Phòng', code: 'GRP_HPV', description: 'Nhóm cán bộ Cảng vụ Hàng hải Hải Phòng', permissions: ['Port:read', 'Berth:read', 'luonghanghai:read', 'data:read'], memberCount: 12, status: 'active' as const, createdAt: '2025-04-01T00:00:00Z', updatedAt: '2026-06-15T00:00:00Z' },
