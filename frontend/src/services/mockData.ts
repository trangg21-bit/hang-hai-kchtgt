...
export const MOCK_ORGANIZATIONS = [
  ...
  // Level 3 — Đại diện
  { id: 'org-013', name: 'Đại diện Cảng vụ Hải Phòng tại Đình Vũ', code: 'DD_CVHP_DV', parentId: 'org-002', parentOrgName: 'Cảng vụ Hàng hải Hải Phòng', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại khu vực Đình Vũ', address: 'KCN Đình Vũ, Hải Phòng', phone: '0225.3768111', contactPerson: 'Hoàng Minh Đức', status: 'approved' as const, childCount: 0, createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-06-15T00:00:00Z' },
  { id: 'org-014', name: 'Đại diện Cảng vụ Quảng Ninh tại Cái Lân', code: 'DD_CVQN_CL', parentId: 'org-003', parentOrgName: 'Cảng vụ Hàng hải Quảng Ninh', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cảng Cái Lân', address: 'Cảng Cái Lân, Hạ Long, Quảng Ninh', phone: '0203.3825999', contactPerson: 'Lê Văn Hải', status: 'approved' as const, childCount: 0, createdAt: '2026-02-01T00:00:00Z', updatedAt: '2026-06-20T00:00:00Z' },
  { id: 'org-015', name: 'Đại diện Cảng vụ TP.HCM tại Cát Lái', code: 'DD_CVHCM_CL', parentId: 'org-004', parentOrgName: 'Cảng vụ Hàng hải TP. Hồ Chí Minh', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cảng Cát Lái', address: 'Cảng Cát Lái, TP. Thủ Đức, TP.HCM', phone: '028.38221999', contactPerson: 'Trần Thanh Tùng', status: 'pending' as const, childCount: 0, createdAt: '2026-03-01T00:00:00Z', updatedAt: '2026-07-01T00:00:00Z' },
  { id: 'org-016', name: 'Đại diện Xí nghiệp BĐAT Đông Bắc Bộ tại Móng Cái', code: 'DD_XNDBB_MC', parentId: 'org-010', parentOrgName: 'Xí nghiệp Bảo đảm An toàn Hàng hải Đông Bắc Bộ', level: 3, type: 'PORT_AUTHORITY' as const, description: 'Văn phòng đại diện tại cửa khẩu Móng Cái', address: 'Số 5 Trần Phú, Móng Cái, Quảng Ninh', phone: '0203.3888123', contactPerson: 'Nguyễn Thanh Hà', status: 'draft' as const, childCount: 0, createdAt: '2026-04-01T00:00:00Z', updatedAt: '2026-07-05T00:00:00Z' },
  { id: 'org-017', name: 'Đại diện Chi cục Hàng hải Miền Bắc tại Hải Dương', code: 'DD_CCMB_HD', parentId: 'org-005', parentOrgName: 'Chi cục Hàng hải Miền Bắc', level: 3, type: 'SUB_DEPARTMENT' as const, description: 'Văn phòng đại diện tại Hải Dương', address: 'Số 10 Nguyễn Lương Bằng, Hải Dương', phone: '0220.3856123', contactPerson: 'Phạm Văn Khánh', status: 'approved' as const, childCount: 0, createdAt: '2026-05-01T00:00:00Z', updatedAt: '2026-07-10T00:00:00Z' },
];
