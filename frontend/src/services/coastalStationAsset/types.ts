...
export interface CoastalStationAsset extends Record<string, unknown> {
  id: string;
...
export type CoastalStationAssetPayload = Omit<CoastalStationAsset, 'id' | 'createdBy' | 'updatedBy' | 'createdAt' | 'updatedAt'>;

export interface CoastalStationAssetFilters extends Record<string, unknown> {
  page?: number;
  size?: number;
  assetCode?: string;
  assetName?: string;
...
export interface CoastalStationAssetExploitation extends Record<string, unknown> {
  id: string;
  assetId: string;
...
export type CoastalStationAssetExploitationPayload = Omit<
  CoastalStationAssetExploitation,
  'id' | 'assetId' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'
>;

export interface CoastalStationAssetAdjustment extends Record<string, unknown> {
  id: string;
  assetId: string;
...
export type CoastalStationAssetAdjustmentPayload = Omit<
