...
import api from './api';
import { updateTransmission } from './transmission/api';
import type { UpdateTransmissionRequest } from './transmission/types';

describe('Transmission Clear Field & Null Handling (/transmission)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('TC-TRANSMISSION-CLEAR-01: sends null instead of undefined when user clears fields', async () => {
    ...
    const payload: UpdateTransmissionRequest = {
      id: '11111111-1111-1111-1111-111111111111',
    ...
    expect(api.put).toHaveBeenCalledWith('/v1/transmission', expect.objectContaining({
      id: '11111111-1111-1111-1111-111111111111',
      detailedLocation: null,
      model: null,
      manufacturer: null,
