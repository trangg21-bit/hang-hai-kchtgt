...
export interface TransmissionAsset extends Record<string, unknown> {
  id: string;
...
export type TransmissionAssetPayload = Omit<TransmissionAsset, 'id' | 'createdBy' | 'updatedBy' | 'createdAt' | 'updatedAt'>;

export interface TransmissionAssetFilters extends Record<string, unknown> {
  page?: number;
  size?: number;
  assetCode?: string;
  assetName?: string;
...
export interface TransmissionAssetExploitation extends Record<string, unknown> {
  id: string;
  assetId: string;
...
export interface TransmissionAssetAdjustment extends Record<string, unknown> {
  id: string;
  assetId: string;
