...
describe('VTS Assist Attached Infrastructure Cascade & Validation (/vts-assist)', () => {
  const mockOrgUnits = [
  ...
  it('TC-VTS-ASSIST-01: Disables and returns empty attached infrastructure when no Đơn vị quản lý is selected', () => {
  ...
  it('TC-VTS-ASSIST-02: Returns only attached infrastructure (VTS center / Radar station) belonging to selected Đơn vị quản lý and its descendants', () => {
