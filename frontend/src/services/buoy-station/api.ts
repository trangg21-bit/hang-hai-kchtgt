import api from '../api';
import type { PageResponse, CreateBuoyStationRequest, BuoyStationResponse } from './types';

// ==========================================
// Nhà trạm phao tiêu (Buoy Station)
// ==========================================
export async function fetchBuoyStationList(params: {
  ...
  const hasFilter = params.code || params.name || params.type || params.status || params.unitId || params.province || params.portId || params.operatingOrgId;
