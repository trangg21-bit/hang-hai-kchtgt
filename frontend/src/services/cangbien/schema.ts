...
export const createSchema = z.object({
  ...
  nhomCangBien: z.coerce.number().int().optional().or(z.nan()),
  ...
  soLuongBenPhao: z.coerce.number().int().min(0).optional().or(z.nan()),
  soLuongKhuNeoDau: z.coerce.number().int().min(0).optional().or(z.nan()),
  soLuongKhuChuyenTai: z.coerce.number().int().min(0).optional().or(z.nan()),
  cacKhuNuocKhac: z.string().max(2000, 'Các khu nước khác tối đa 2000 ký tự').optional().or(z.literal('')),
  ghiChu: z.string().max(2000, 'Ghi chú tối đa 2000 ký tự').optional().or(z.literal('')),
}).refine(
...
export const updateSchema = z.object({
  ...
  ghiChu: z.string().max(2000, 'Ghi chú tối đa 2000 ký tự').optional().nullable(),
}).refine(
  (data) => (data.viDo === undefined || Number.isNaN(data.viDo)) === (data.kinhDo === undefined || Number.isNaN(data.kinhDo)),
  {
    message: 'Vĩ độ và kinh độ phải được cung cấp cùng nhau hoặc để trống cùng nhau',
