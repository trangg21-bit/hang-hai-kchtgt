...
vi.mock('./transmission/api', () => ({
  fetchTransmissionList: vi.fn().mockResolvedValue({ content: [], totalElements: 0 }),
  fetchTransmissionById: vi.fn().mockResolvedValue({}),
  createTransmission: vi.fn().mockResolvedValue({}),
  updateTransmission: vi.fn().mockResolvedValue({}),
  deleteTransmission: vi.fn().mockResolvedValue({}),
  generateTransmissionCode: vi.fn().mockResolvedValue('TRANSMISSION-TEST-001'),
  fetchOperatingOrganizations: vi.fn().mockResolvedValue([]),
  fetchTransmissionAttachments: vi.fn().mockResolvedValue([]),
}));
...
describe('Transmission Default Managing Unit (/transmission)', () => {
