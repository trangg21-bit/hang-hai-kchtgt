...
vi.mock('./vhf/api', () => ({
  generateVhfCode: vi.fn().mockResolvedValue('VHF-TEST-001'),
  fetchVhfList: vi.fn().mockResolvedValue({ items: [], total: 0 }),
  fetchVhfById: vi.fn().mockResolvedValue({}),
  createVhf: vi.fn().mockResolvedValue({}),
  updateVhf: vi.fn().mockResolvedValue({}),
  deleteVhf: vi.fn().mockResolvedValue({}),
  submitVhf: vi.fn().mockResolvedValue({}),
  approveVhfC1: vi.fn().mockResolvedValue({}),
  approveVhfC2: vi.fn().mockResolvedValue({}),
  fetchVhfAttachments: vi.fn().mockResolvedValue([]),
  downloadVhfAttachment: vi.fn().mockResolvedValue(undefined),
  fetchOperatingOrganizations: vi.fn().mockResolvedValue([]),
  fetchVhfHistory: vi.fn().mockResolvedValue([]),
}));
...
describe('VHF Default Managing Unit (/vhf)', () => {
