...
export interface VtsAssistAsset extends Record<string, unknown> {
  id: string;
...
export type VtsAssistAssetPayload = Omit<VtsAssistAsset, 'id' | 'createdBy' | 'updatedBy' | 'createdAt' | 'updatedAt'>;

export interface VtsAssistAssetFilters extends Record<string, unknown> {
  page?: number;
  size?: number;
  assetCode?: string;
  assetName?: string;
...
export interface VtsAssistAssetExploitation extends Record<string, unknown> {
  id: string;
  assetId: string;
...
export interface VtsAssistAssetAdjustment extends Record<string, unknown> {
  id: string;
  assetId: string;
