...
describe('Transmission Attached Infrastructure Cascade & Validation (/transmission)', () => {
  const mockOrgUnits = [
  ...
  it('TC-TRANS-01: Disables and returns empty attached infrastructure when no Đơn vị quản lý is selected', () => {
  ...
  it('TC-TRANS-02: Returns only attached infrastructure (VTS center / Radar station) belonging to selected Đơn vị quản lý and its descendants', () => {
  ...
  it('TC-TRANS-03: Resets attached infrastructure if currently selected item does not belong to new Đơn vị quản lý', () => {
  ...
  it('TC-TRANS-04: Keeps attached infrastructure if currently selected item belongs to new Đơn vị quản lý', () => {
