...
vi.mock('./vtsassist/api', () => ({
  fetchVtsAssistList: vi.fn().mockResolvedValue({ content: [], totalElements: 0 }),
  fetchVtsAssistById: vi.fn().mockResolvedValue({}),
  createVtsAssist: vi.fn().mockResolvedValue({}),
  updateVtsAssist: vi.fn().mockResolvedValue({}),
  deleteVtsAssist: vi.fn().mockResolvedValue({}),
  generateVtsAssistCode: vi.fn().mockResolvedValue('VTSASSIST-TEST-001'),
  fetchOperatingOrganizations: vi.fn().mockResolvedValue([]),
  fetchVtsAssistAttachments: vi.fn().mockResolvedValue([]),
}));
...
describe('VTS Assist Default Managing Unit (/vts-assist)', () => {
