...
export default function AppLayout({ initialSidebarHidden }: { initialSidebarHidden?: boolean } = {}) {
  ...
  const rawMenuItems: MenuProps['items'] = [
    ...
    canAccessMenu('/port') ? { key: '/port', icon: <ContainerOutlined />, label: 'Quản lý KCHT hàng hải' } : null,
    { type: 'divider' as const },
    // Nhóm 2 — Quản lý tài sản KCHT hàng hải
    {
      ...
      children: [
        ...
        canAccessMenu('/asset/vts-system') ? { key: '/asset/vts-system', icon: <ControlOutlined />, label: 'Tài sản hệ thống VTS' } : null,
        canAccessMenu('/asset/radar-station') ? { key: '/asset/radar-station', icon: <RadarChartOutlined />, label: 'Tài sản trạm radar' } : null,
        canAccessMenu('/asset/ais-system') ? { key: '/asset/ais-system', icon: <WifiOutlined />, label: 'Tài sản hệ thống AIS' } : null,
        canAccessMenu('/asset/cctv-system') ? { key: '/asset/cctv-system', icon: <VideoCameraOutlined />, label: 'Tài sản HT CCTV' } : null,
        canAccessMenu('/asset/scada-system') ? { key: '/asset/scada-system', icon: <MonitorOutlined />, label: 'Tài sản HT SCADA' } : null,
        ...
        canAccessMenu('/asset/dai-ttdh') ? { key: '/asset/dai-ttdh', icon: <SoundOutlined />, label: 'Tài sản đài TTDH' } : null,
