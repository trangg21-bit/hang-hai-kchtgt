...
export const MENU_PERMISSION_MAP: Record<string, string | string[]> = {
  ...
  '/asset/vts-system': 'infraasset:manage',
  '/asset/radar-station': 'infraasset:manage',
  '/asset/ais-system': 'infraasset:manage',
  '/asset/cctv-system': 'infraasset:manage',
  '/asset/scada-system': 'infraasset:manage',
  '/asset/transmission': 'infraasset:manage',
  '/asset/vts-assist': 'infraasset:manage',
  '/asset/vhf': 'infraasset:manage',
  '/asset/dai-ttdh': 'infraasset:manage',
  '/asset/inmarsat': 'infraasset:manage',
  '/asset/transfer-area': 'infraasset:manage',
  '/asset/storm-shelter': 'infraasset:manage',
  '/asset/buoy-berth': 'infraasset:manage',
  '/asset/pier': 'infraasset:manage',
  ...
  '/asset/dry-port': 'infraasset:manage',
  '/asset/lrit': 'infraasset:manage',
  '/asset/cospas-sarsat': 'infraasset:manage',
  '/asset/ttxltt': 'infraasset:manage',
  '/asset/inmarsat': 'infraasset:manage',
  '/asset/ttdh': 'infraasset:manage',
  ...
  '/vts-operation-center': ['vtsoperationcenter:read', 'vts:read'],
  ...
  '/station/cospas-sarsat': ['specialstation:read', 'coastalstationcospassarsat:read', 'coastalstation:read', 'data:read'],
  '/station/lrit': ['specialstation:read', 'coastalstationlrit:read', 'coastalstation:read', 'data:read'],
  '/station/hanoi': ['specialstation:read', 'coastalstationhaiphong:read', 'coastalstation:read', 'data:read'],
