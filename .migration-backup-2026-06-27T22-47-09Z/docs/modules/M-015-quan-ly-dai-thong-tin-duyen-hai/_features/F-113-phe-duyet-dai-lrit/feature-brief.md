...
consumed_by_modules: []
---
# Feature: Phê duyệt Đại LRIT

## Description
Cho phép lãnh đạo cấp Phòng và cấp Cục thực hiện quy trình phê duyệt hai cấp cho các yêu cầu tạo mới, cập nhật hoặc xóa Đại LRIT (trạm thu nhận thông tin vị trí tàu LRIT). Hệ thống quản lý luồng phê duyệt tuần tự từ Phòng lên Cục, với đầy đủ chức năng xem chi tiết, bình luận và ghi chú phê duyệt.

## Business Intent
Quy trình phê duyệt hai cấp (Phòng → Cục) đảm bảo mọi thay đổi về thông tin Đại LRIT đều được kiểm tra và chấp thuận bởi các cấp quản lý có thẩm quyền, đảm bảo tính chính xác và tuân thủ của dữ liệu hệ thống thu nhận thông tin vị trí tàu LRIT theo quy định IMO SOLAS Chapter V về giám sát tàu thuyền trên biển.

## Flow Summary
Lãnh đạo cấp Phòng nhận được thông báo yêu cầu phê duyệt, truy cập hệ thống để xem chi tiết yêu cầu (tạo mới/cập nhật/xóa), kiểm tra thông tin kỹ thuật (loại antenna, tần số L-band, phạm vi thu, vị trí địa lý), thêm ghi chú nếu cần, sau đó chọn Phê duyệt hoặc Từ chối. Nếu được Phòng phê duyệt, yêu cầu chuyển lên Cấp Cục để xem xét và phê duyệt cấp 2. Sau khi cả hai cấp đều phê duyệt, bản ghi được cập nhật chính thức.
...
## In Scope
- Giao diện xem chi tiết yêu cầu phê duyệt (thông tin kỹ thuật LRIT)
...
## Entities
- **CoastalStationLRIT**: id, device_code, station_name, antenna_type, receive_frequency, receive_range_km, status (pending/approved/rejected), version
