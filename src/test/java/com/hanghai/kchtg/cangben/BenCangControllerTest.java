...
class BenCangControllerTest {
    ...
    void findAll_returns200() throws Exception {
        ...
        when(benCangService.findAll(0, 20, null, null, null, null, null, null, null, null, null)).thenReturn(page);
    ...
    void findAll_paginationParams_forwarded() throws Exception {
        ...
        when(benCangService.findAll(1, 5, someUuid, null, null, null, null, null, null, null, null)).thenReturn(page);
        ...
        verify(benCangService).findAll(1, 5, someUuid, null, null, null, null, null, null, null, null);
    }
