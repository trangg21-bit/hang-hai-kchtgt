...
class MaterializedPathServiceTest {
    ...
    private org.springframework.data.jpa.repository.EntityManager entityManager;
    ...
    void setUp() {
        ...
        entityManager = org.mockito.Mockito.mock(org.springframework.data.jpa.repository.EntityManager.class);
    }
