...
class PasswordPolicyValidatorTest {
    ...
    @Test
    void validate_shouldPassEdgeCaseExactly12Chars() {
        assertDoesNotThrow(() -> validator.validate("Ab1!Xy9@Mn2p"));
    }

    @Test
    void getMinLength_shouldReturn12() {
        assertEquals(12, validator.getMinLength());
    }
