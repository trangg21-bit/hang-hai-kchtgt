...
class VtsSystemServiceTest {
    ...
    @Test
    void testSearch() {
        when(repository.search(false, null, null, null, null, null, null, org.springframework.data.domain.PageRequest.of(0, 100))).thenReturn(org.springframework.data.domain.Page.empty());
