...
public class DaiTtdh extends BaseEntity implements ApprovableEntity {
    ...
    @Override
    public void setApprovedDateLevel1(java.time.LocalDateTime date) {
    ...
    @Override
    public void setApprovedDateLevel2(java.time.LocalDateTime date) {
