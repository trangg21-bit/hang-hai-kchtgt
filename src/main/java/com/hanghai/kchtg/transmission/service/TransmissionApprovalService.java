...
public class TransmissionApprovalService {
  ...
  public TransmissionApprovalService(
      TransmissionRepository transmissionRepository,
      InfrastructureApprovalService approvalService,
      TransmissionService transmissionService,
      InfrastructureHistoryRepository historyRepository,
      UserRepository userRepository) {
    this(transmissionRepository, approvalService, transmissionService, historyRepository, userRepository,
  ...
  public List<HistoryEntry> getHistory(UUID id, Integer page, Integer pageSize, String keyword,
    ...
    Transmission parent = transmissionRepository.findById(id)
      .orElseThrow(() -> new EntityNotFoundException("Không tìm thấy hệ thống truyền dẫn với id: " + id));
    ...
    if (normalizedKeyword == null && fromDate == null && toDate == null) {
      list = paged
          ? historyRepository.findByRefTypeAndRefIdOrderByApprovedDateDesc(InfrastructureType.TRANSMISSION, id, PageRequest.of(page, pageSize))
          : historyRepository.findByRefTypeAndRefIdOrderByApprovedDateDesc(InfrastructureType.TRANSMISSION, id);
    } else {
      list = historyRepository.searchHistory(InfrastructureType.TRANSMISSION, id, normalizedKeyword, fromDate, toDate,
  ...
  private static String canonicalizeFieldName(String field) {
    ...
    return switch (norm) {
      ...
      case "operatingunitid", "đơn vị khai thác", "don vi khai thac" -> "operatingUnitId";
      case "provincename", "tỉnh/thành phố", "tinh/thanh pho", "province" -> "provinceName";
      case "attachedinfrastructuretype", "loại hạ tầng", "loai ha tang" -> "attachedInfrastructureType";
      ...
      case "coordinatesystem", "hệ quy chiếu", "he quy chieu" -> "coordinateSystem";
