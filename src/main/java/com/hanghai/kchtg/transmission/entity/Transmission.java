package com.hanghai.kchtg.transmission.entity;
...
/**
 * Entity representing a transmission system (Hệ thống truyền dẫn) — M-NEW entity.
 * Corresponds to table: transmission.
 * <p>
 * Uses BaseEntity for UUID PK, soft-delete, and JPA auditing.
 * The device_code is immutable after creation, tự sinh prefix TRD-{seq}.
 * </p>
 */
@Entity
