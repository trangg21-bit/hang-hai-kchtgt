...
public class EffectivePermissionService {
    ...
    private static final Map<String, Set<String>> RESOURCE_PARENT_DOMAINS = Map.ofEntries(
            Map.entry("port", Set.of("infraasset", "data", "stormshelterasset", "stormshelter", "berthasset", "berth", "pierasset", "pier", "anchorageasset", "anchorage", "buoyberthasset", "buoyberth", "transferareaasset", "transferarea", "dryportasset", "dryport")),
            Map.entry("seaport", Set.of("infraasset", "data", "stormshelterasset", "stormshelter", "berthasset", "berth", "pierasset", "pier", "anchorageasset", "anchorage", "buoyberthasset", "buoyberth", "transferareaasset", "transferarea", "dryportasset", "dryport")),
            Map.entry("vtsasset", Set.of("infraasset", "vts", "vtssystem", "data")),
            Map.entry("radarasset", Set.of("infraasset", "radarstation", "tramradar", "data")),
            Map.entry("aisasset", Set.of("infraasset", "aissystem", "data")),
            Map.entry("cctvasset", Set.of("infraasset", "cctv", "data")),
            Map.entry("scadaasset", Set.of("infraasset", "scada", "data")),
            Map.entry("transmissionasset", Set.of("infraasset", "transmission", "data")),
            ...
            Map.entry("inmarsatasset", Set.of("infraasset", "inmarsat", "coastalstationinmarsat", "specialstation", "coastalstation", "data")),
