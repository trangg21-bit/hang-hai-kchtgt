...
public class PointApprovalStatusConverter implements AttributeConverter<ApprovalStatus, Integer> {
    @Override
    ...
    public ApprovalStatus convertToEntityAttribute(Integer dbData) {
        ...
        throw new IllegalArgumentException("Unknown database value for PointObject.ApprovalStatus: " + dbData);
    }
}
