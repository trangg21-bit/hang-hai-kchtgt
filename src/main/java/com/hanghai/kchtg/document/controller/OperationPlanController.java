...
public class OperationPlanController {
     ...
     */
    @PostMapping
    @PreAuthorize("@auth.check(authentication, 'operationplan:create')")
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("@auth.check(authentication, 'operationplan:update')")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("@auth.check(authentication, 'operationplan:delete')")
