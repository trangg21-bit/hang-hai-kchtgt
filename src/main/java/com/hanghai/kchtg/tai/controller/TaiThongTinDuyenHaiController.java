...
public class TaiThongTinDuyenHaiController {
    ...
    public ResponseEntity<ApiResponse<TaiThongTinDuyenHaiResponse>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Tao đài thông tin duyên hải thành công", response));
    }
    ...
    public ResponseEntity<ApiResponse<TaiThongTinDuyenHaiResponse>> update(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                "Cap nhat đài thông tin duyên hải thành công", response));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable String code) {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Da xoa đài thông tin duyên hải thành công", null));
    }
