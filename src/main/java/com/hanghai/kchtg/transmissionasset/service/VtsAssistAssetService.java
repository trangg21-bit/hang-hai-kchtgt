...
public class VtsAssistAssetService {

    public static final String ASSET_TYPE = "Tài sản hệ thống phụ trợ VTS";

    private final TransmissionAssetService service;

    public VtsAssistAssetService(TransmissionAssetService service) {
