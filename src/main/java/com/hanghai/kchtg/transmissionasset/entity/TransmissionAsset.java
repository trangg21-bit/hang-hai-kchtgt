...
@Entity
@Table(name = "transmission_assets")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class TransmissionAsset extends BaseEntity {
    ...
    @Column(length = 100)
    @Builder.Default
    private String assetType = "Tài sản HT truyền dẫn";
    ...
    @Column(length = 100)
    @Builder.Default
    private String assetCondition = "Tốt";

    @Column(length = 100)
    @Builder.Default
    private String usageStatus = "Đang sử dụng";
    ...
    @Column(length = 50)
    @Builder.Default
    private String quantityUnit = "Bộ";
