 ...
 */
@Entity
@Table(name = "yeu_cau_giam_tai_san")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class YeuCauGiamTaiSan {
    ...
    @Column(length = 50)
    private NguyenNhanGiam nguyenNhanGiam;

    private Instant ngayGiam;

    @Column(length = 1000)
    private String bienBanKiemTra;
