...
public class TransferAreaAssetService extends BaseInfraAssetTypeService {

    public TransferAreaAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.TRANSFER_AREA);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID transferAreaId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                transferAreaId, null, null, null, null, null, null, null, null, null,
