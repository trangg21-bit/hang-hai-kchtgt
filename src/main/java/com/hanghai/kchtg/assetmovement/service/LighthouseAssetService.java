...
public class LighthouseAssetService extends BaseInfraAssetTypeService {

    public LighthouseAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.LIGHTHOUSE);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID beaconStationId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, null, null, null, null, beaconStationId, null, null, null, null,
