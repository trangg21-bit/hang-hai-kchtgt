...
public class BuoyAssetService extends BaseInfraAssetTypeService {

    public BuoyAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.BUOY);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID buoyId, UUID buoyStationId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, null, null, null, null, null, null, buoyId, buoyStationId, null,
