...
public class PierAssetService extends BaseInfraAssetTypeService {

    public PierAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.PIER);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID pierId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, null, null, pierId, null, null, null, null, null, null,
