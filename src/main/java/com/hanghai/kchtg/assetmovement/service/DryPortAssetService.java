...
public class DryPortAssetService extends BaseInfraAssetTypeService {

    public DryPortAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.DRY_PORT);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID dryPortId, String types, String assetCondition,
