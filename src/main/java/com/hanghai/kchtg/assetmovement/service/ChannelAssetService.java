...
public class ChannelAssetService extends BaseInfraAssetTypeService {

    public ChannelAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.NAVIGATION_CHANNEL);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID navigationChannelId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, null, null, null, null, null, null, null, null, navigationChannelId,
