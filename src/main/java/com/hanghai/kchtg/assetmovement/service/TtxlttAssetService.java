...
public class TtxlttAssetService extends BaseInfraAssetTypeService {

    public TtxlttAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.TTXLTT_STATION);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID ttxlttStationId, String types, String assetCondition,
