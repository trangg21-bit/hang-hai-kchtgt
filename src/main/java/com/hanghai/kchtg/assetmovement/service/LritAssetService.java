...
public class LritAssetService extends BaseInfraAssetTypeService {

    public LritAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.LRIT_STATION);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID lritStationId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, lritStationId, null, null, null,
                null, null, null,
