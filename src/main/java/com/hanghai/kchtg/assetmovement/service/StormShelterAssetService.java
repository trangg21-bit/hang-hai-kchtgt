...
public class StormShelterAssetService extends BaseInfraAssetTypeService {

    public StormShelterAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.STORM_SHELTER);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID stormShelterId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, stormShelterId, null, null, null, null, null, null, null, null,
