...
public class AnchorageAssetService extends BaseInfraAssetTypeService {

    public AnchorageAssetService(InfraAssetService infraAssetService) {
        super(infraAssetService, InfraAssetType.ANCHORAGE);
    }
    ...
    public Page<InfraAssetResponse> findAll(
            ...
            UUID anchorageId, String types, String assetCondition,
        ...
        return infraAssetService.findAll(
                ...
                null, null, null,
                null, null, null, null, anchorageId, null, null, null, null, null,
