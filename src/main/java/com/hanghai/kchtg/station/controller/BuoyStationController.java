...
public class BuoyStationController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAllHistory() {
        List<InfrastructureHistory> list =
                historyRepository.findByRefTypeOrderByApprovedDateDesc(InfrastructureType.BUOY_STATION);
        ...
        List<Map<String, Object>> changeHistory = list.stream()
                ...
                .toList();
        return ResponseEntity.ok(ApiResponse.success(
                Map.of("entityType", "BuoyStation", "changeHistory", changeHistory, "entityNames", entityNames)));
    }
}
