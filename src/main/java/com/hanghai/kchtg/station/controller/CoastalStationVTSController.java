...
public class CoastalStationVTSController {
    ...
    @PreAuthorize("hasAnyAuthority('coastalstation:create', 'coastalstation:update', 'station:create', 'station:update', 'data:create')")
    ...
    @PreAuthorize("hasAnyAuthority('coastalstation:approvec1', 'coastalstation:approve', 'station:approvec1', 'station:approve', 'data:approvec1', 'data:approve')")
    ...
    @PreAuthorize("hasAnyAuthority('coastalstation:approvec2', 'coastalstation:approve', 'station:approvec2', 'station:approve', 'data:approvec2', 'data:approve')")
    ...
    @PreAuthorize("hasAnyAuthority('coastalstation:approvec1', 'coastalstation:approvec2', 'coastalstation:approve', 'station:approve', 'data:approve')")
    ...
    @PreAuthorize("hasAnyAuthority('coastalstation:reject', 'coastalstation:approvec1', 'coastalstation:approvec2', 'coastalstation:approve', 'station:reject', 'station:approve', 'data:approve')")
