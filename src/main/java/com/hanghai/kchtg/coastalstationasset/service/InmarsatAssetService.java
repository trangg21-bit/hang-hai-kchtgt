...
public class InmarsatAssetService {

    public static final String ASSET_TYPE = "Tài sản đài Inmarsat";

    private final CoastalStationAssetService service;

    public InmarsatAssetService(CoastalStationAssetService service) {
