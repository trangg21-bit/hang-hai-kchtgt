...
### Vung nuoc (WaterZone) — BE+UI merged

- **F-032** ql-vn-tao-moi — status: `done` — merged with F-090 (UI)
- **F-033** ql-vn-cap-nhat — status: `done` — merged with F-091 (UI)
- **F-034** ql-vn-xoa — status: `done` — merged with F-101 (UI)
- **F-035** phe-duyet-vn — status: `done` — merged with F-092 (UI)
- **F-036** xem-vn — status: `done` — merged with F-088 (UI list) + F-089 (UI detail)
- **F-037** ql-vn-lich-su — status: `done` — merged with F-102 (UI)
