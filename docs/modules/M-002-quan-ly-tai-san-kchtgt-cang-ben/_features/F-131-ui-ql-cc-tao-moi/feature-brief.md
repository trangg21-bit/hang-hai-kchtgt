...
8. Click "Lưu" gọi POST /api/v1/cang-can với đầy đủ dữ liệu từ form; nếu thành công hiển thị toast "Tạo mới cảng cạn thành công" và chuyển hướng về danh sách (F-129).
9. Nếu có lỗi validation từ BE, hiển thị message error chi tiết cho từng trường bị lỗi ngay dưới trường tương ứng.
10. Click "Hủy" hoặc "Quay lại" chuyển người dùng về danh sách cảng cạn (F-129) mà không lưu dữ liệu.
