---
id: F-129
name: "Danh sach Cang Can"
slug: ui-ql-cc-danh-sach
module-id: M-002
status: proposed
classification: local
priority: medium
created: "2026-07-01T07:51:04Z"
last-updated: "2026-07-01T07:51:04Z"
locked-fields: []
consumed_by_modules: []
---

# Feature: Danh sach Cang Can

## Description

Tính năng Danh sach Cang Can cung cấp giao dien bieu bang liet ke tat ca cac cong cang can thuoc cong bien duoc quan ly trong he thong, voi kha nang phan trang (20 hoac 100 muc/trang), sap xeu mac dinh theo truong updatedAt giam dan (moi nhat hien thi dau tien). Ngua dung co the tim kiem nhanh bang ma cang can (maCangCan) hoac ten cang can (tenCangCan), dong thoi loc theo trang thai hoat dong (HIEN_HANH, TAM_NGUNG) va theo trang thai phe duyet (CHU_PHE_DUYET, DUOC_PHE_DUYET, TU_CHOI). Bieu bang hien thi cac truong: ma cang can, ten cang can, tinh/thanh pho, dien tich (m2), cong suat TEU, toa do (vi do, kinh do), trang thai hoat dong (badge mau), trang thai phe duyet, va ngay cap nhat cuoi cung. Tu bieu bang danh sach, ngua dung co the thuc hien cac hanh dong: xem chi tiet, chinh sua, xoa (dung soft-delete) va xem lich su thay doi. Doi voi ngua dung co vai tro Lanh dao/Phê duyet, them hanh dong Phê duyêt cang can trong trang thai cho duyêt. Giao diện hỗ trợ điều hướng bằng bàn phím: Tab để di chuyển giữa các trường filter và Enter để kích hoạt hành động.
...
- CRUD cảng cạn (các tính năng này nằm ở F-131, F-132, F-134, F-135)
