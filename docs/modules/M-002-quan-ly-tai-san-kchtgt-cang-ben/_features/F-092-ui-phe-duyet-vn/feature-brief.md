...
priority: medium
created: "2026-07-01T04:08:48Z"
last-updated: "2026-07-01T04:08:48Z"
locked-fields: []
consumed_by_modules: []
---
...
- Chỉnh sửa thông tin vùng nước (thuộc F-091)
- Xóa vùng nước (thuộc F-101)
- Xem lịch sử thay đổi (thuộc F-102)
...
| PheDuyetLog | id (UUID), vungNuocId (UUID), pheDuyetVienId (UUID), hanhDong (enum: APPROVE, REJECT), lyDo (text), pheDuyetThoiGian (datetime), ghiChu (text) |
