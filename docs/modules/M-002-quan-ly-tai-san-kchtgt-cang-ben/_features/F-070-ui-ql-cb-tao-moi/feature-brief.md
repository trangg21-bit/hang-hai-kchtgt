...
|---|---|---|---|
| BR-001 | maCang định dạng VN-36, độ dài 6-10 ký tự, phải unique toàn hệ thống | maCang | Entity spec, F-070 |
...
| BR-004 | maCang không thể thay đổi sau khi tạo (readonly) | maCang | F-070, F-008 |
| BR-005 | Nếu maCang đã tồn tại, API trả HTTP 409 Conflict | Tạo mới | F-070, F-008 |
