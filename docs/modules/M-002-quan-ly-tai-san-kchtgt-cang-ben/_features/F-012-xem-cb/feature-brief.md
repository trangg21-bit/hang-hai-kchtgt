...
- Theo tài liệu nền mục 3.5 (các trạng thái enum `ApprovalStatus` — 10 giá trị có label, lưu dạng số; quy trình 2 cấp theo `QUY-TRINH-PHE-DUYET-2-CAP-KCHT.md`).
...
|---|---|---|
| 1 | Trạng thái riêng | Không — hiển thị trạng thái chung (badge theo enum `ApprovalStatus`) |
