---
id: F-108
name: "Danh sach Cang Bien"
slug: ui-ql-cb-danh-sach
module-id: M-002
status: proposed
classification: local
priority: medium
created: "2026-07-01T07:49:57Z"
last-updated: "2026-07-01T07:49:57Z"
locked-fields: []
consumed_by_modules: []
---

# Feature: Danh sach Cang Bien
...
4. Bảng hiển thị 5 cột: maCang, tenCang, tinhThanhPho, trạng thái (badge màu theo trạng thái phê duyệt), updatedAt — sortable theo các cột này.
...
- Thêm mới cảng biển (thuộc F-110)
- Chỉnh sửa chi tiết cảng (thuộc F-111)
- Phê duyệt/từ chối (thuộc F-112)
- Xóa mềm cảng (thuộc F-113)
...
|---|---|---|---|
| BR-001 | maCang phải tuân thủ định dạng VN-36, độ dài 6-10 ký tự và phải là duy nhất trên toàn hệ thống | Tạo / Danh sách | Entity spec, F-110 |
...
| BR-004 | Xóa mềm bị chặn nếu tồn tại con (BenCang/VungNuoc), trả về HTTP 409 | Xóa | F-113, F-010 |
| BR-005 | Chỉ người dùng có vai trò Lãnh đạo mới thấy và thực hiện hành động Phê duyệt/Từ chối | Phê duyệt | F-112 |
