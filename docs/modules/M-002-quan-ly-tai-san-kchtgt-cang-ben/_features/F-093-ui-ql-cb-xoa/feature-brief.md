...
last-updated: "2026-07-01T04:09:05Z"
locked-fields: []
consumed_by_modules: []
---

# Feature: Xóa Cảng biển
...
4. Xác nhận đúng → gọi DELETE /api/v1/cang-bien/:id → server set deletedAt = now() (soft delete) → toast "Đã xóa thành công" → điều hướng về danh sách (F-068).
