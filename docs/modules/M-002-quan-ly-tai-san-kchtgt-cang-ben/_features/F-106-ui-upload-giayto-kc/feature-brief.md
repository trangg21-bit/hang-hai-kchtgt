...
priority: medium
created: "2026-07-01T06:56:40Z"
last-updated: "2026-07-01T06:56:40Z"
locked-fields: []
consumed_by_modules: []
---
...
11. GiayTo entity fields: id (UUID), entityType (string: cang-can), entityId (string), fileName (string), fileSize (Long), mimeType (string), minioKey (string), uploadedBy (string), createdAt (LocalDateTime).
...
- GET /api/v1/giay-to?entityType=cang-can&entityId=uuid — liệt kê file đính kèm.
...
- **GiayTo**: id (UUID), entityType (string: cang-can), entityId (string), fileName (string), fileSize (Long), mimeType (string, any MIME type), minioKey (string), uploadedBy (string), createdAt (LocalDateTime)
