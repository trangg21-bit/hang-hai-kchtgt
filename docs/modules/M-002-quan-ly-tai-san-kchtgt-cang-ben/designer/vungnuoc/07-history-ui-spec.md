# UI Specification: VungNuoc — History Page

## Page: History (Lịch sử thay đổi Vùng nước)

### 1. Component Structure
```
VungNuocHistoryPage
├── PageHeader (title: "Lịch sử thay đổi", breadcrumbs, backBtn)
├── EntitySummaryCard (read-only: maVungNuoc, tenVungNuoc, cangBienId, dienTich, doSauMax, doSauTrungBinh, loaiVungNuoc)
└── HistoryTimeline
...
|---|---|---|---|
| Get History | /api/v1/vung-nuoc/{id}/history | GET | - |
...
### 7. Error Handling
- **404**: "Không tìm thấy vùng nước." with back.
