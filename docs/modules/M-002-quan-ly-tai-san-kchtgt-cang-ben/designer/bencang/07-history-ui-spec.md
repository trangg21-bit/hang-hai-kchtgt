# UI Specification: BenCang — History Page

## Page: History (Lịch sử thay đổi Bến cảng)

### 1. Component Structure
```
BenCangHistoryPage
├── PageHeader (title: "Lịch sử thay đổi", breadcrumbs, backBtn)
├── EntitySummaryCard (read-only: maBen, tenBen, cangBienId, tuyenDuongThuy)
└── HistoryTimeline
...
### 4. Form/Table Layout
- **PageHeader**: "Lịch sử thay đổi — [maBen] | [tenBen]", breadcrumbs, Back.
...
|---|---|---|---|
| Get History | /api/v1/ben-cang/{id}/history | GET | - |
...
### 7. Error Handling
- **404**: "Không tìm thấy bến cảng." with back.
