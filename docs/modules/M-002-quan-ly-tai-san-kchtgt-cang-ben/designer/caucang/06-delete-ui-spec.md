# UI Specification: CauCang — Delete Page

## Page: Delete Confirm (Xác nhận xóa Cầu cảng)
...
│   ├── Mã cầu: [maCau]
│   ├── Tên cầu: [tenCau]
│   ├── Bến cảng chủ: [benCang.tenBen]
│   ├── Chiều dài: [chieuDai], Tải trọng: [taiTrong], Loại: [loaiCau]
...
### 7. Error Handling
- **403**: "Bạn không có quyền xóa cầu cảng này."
- **404**: "Không tìm thấy cầu cảng để xóa."
- **Success**: Toast "Xóa cầu cảng thành công" + close + refresh.
