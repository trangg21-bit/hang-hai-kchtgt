---
feature-id: F-145
feature-name: "Mẫu số 04: Báo cáo tình hình xử lý tài sản KCHT hàng hải"
module-id: M-008
status: in-progress
created: 2026-06-26
...
# Đặc tả nghiệp vụ: Mẫu số 04: Báo cáo tình hình xử lý tài sản KCHT hàng hải
...
Chuyển đổi BCC_160 sang F-145 theo template nguồn.
...
| 2 | Kỳ/năm/nội dung/hình thức | Theo báo cáo | Ngày bắt đầu không sau ngày kết thúc | Lọc ngày ghi nhận tài sản trong kỳ; tổng hợp doanh thu/chi phí/nộp ngân sách theo asset_id trước khi ghép; các khoản khai thác không lọc kỳ theo logic nguồn. |
| 3 | Kết quả | Chỉ đọc | Các cột F-144; thêm hình thức xử lý; tổng tiền thu; chi phí; nộp ngân sách. | Đơn vị tiền: nghìn đồng |
...
Lọc ngày ghi nhận tài sản trong kỳ; tổng hợp doanh thu/chi phí/nộp ngân sách theo asset_id trước khi ghép; các khoản khai thác không lọc kỳ theo logic nguồn.
...
|---|---|---|---|
| POST | `/api/v1/reports/preview` | reportCode F-145 hoặc BCC_160 | `report:read` |
