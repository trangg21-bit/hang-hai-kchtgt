---
feature-id: F-144
feature-name: "Mẫu số 03: Báo cáo tình hình quản lý tài sản KCHT hàng hải"
module-id: M-008
status: in-progress
created: 2026-06-26
...
# Đặc tả nghiệp vụ: Mẫu số 03: Báo cáo tình hình quản lý tài sản KCHT hàng hải
...
Chuyển đổi BCC_159 sang F-144 theo template nguồn.
...
| 2 | Kỳ/năm/nội dung/hình thức | Theo báo cáo | Ngày bắt đầu không sau ngày kết thúc | Lọc ngày ghi nhận created_at trong khoảng chọn, gồm cả ngày kết thúc. |
...
Lọc ngày ghi nhận created_at trong khoảng chọn, gồm cả ngày kết thúc.
...
|---|---|---|---|
| POST | `/api/v1/reports/preview` | reportCode F-144 hoặc BCC_159 | `report:read` |
