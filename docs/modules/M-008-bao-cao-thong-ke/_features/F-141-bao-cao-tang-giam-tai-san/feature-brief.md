---
feature-id: F-141
feature-name: "Báo cáo thống kê tăng giảm tài sản"
module-id: M-008
status: in-progress
created: 2026-06-26
...
# Đặc tả nghiệp vụ: Báo cáo thống kê tăng giảm tài sản
...
Chuyển đổi BCC_156 sang F-141 theo template nguồn.
...
| 2 | Kỳ/năm/nội dung/hình thức | Theo báo cáo | Ngày bắt đầu không sau ngày kết thúc | Ngày ghi nhận created_at; đầu kỳ trước ngày bắt đầu, tăng/giảm trong kỳ theo disposal_method; ngày kết thúc bao gồm cả ngày. |
| 3 | Kết quả | Chỉ đọc | STT; loại tài sản; số lượng, diện tích, nguyên giá cho đầu kỳ/tăng/giảm/cuối kỳ. | Đơn vị tiền: nghìn đồng |
...
Ngày ghi nhận created_at; đầu kỳ trước ngày bắt đầu, tăng/giảm trong kỳ theo disposal_method; ngày kết thúc bao gồm cả ngày.
...
|---|---|---|---|
| POST | `/api/v1/reports/preview` | reportCode F-141 hoặc BCC_156 | `report:read` |
