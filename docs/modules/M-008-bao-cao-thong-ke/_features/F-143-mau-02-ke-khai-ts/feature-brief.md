---
feature-id: F-143
feature-name: "Mẫu số 02: Báo cáo kê khai tài sản KCHT hàng hải"
module-id: M-008
status: in-progress
created: 2026-06-26
...
# Đặc tả nghiệp vụ: Mẫu số 02: Báo cáo kê khai tài sản KCHT hàng hải
...
Chuyển đổi BCC_158 sang F-143 theo template nguồn.
...
| 2 | Kỳ/năm/nội dung/hình thức | Theo báo cáo | Ngày bắt đầu không sau ngày kết thúc | Nội dung 1: declaration_date <= 04/04/2025; nội dung 2: sau ngày này. Không lọc ngày ghi nhận theo kỳ. |
| 3 | Kết quả | Chỉ đọc | STT; danh mục; đơn vị tính; số lượng; năm xây dựng/sử dụng; diện tích đất/sàn; nguyên giá; giá trị còn lại; tình trạng; ghi chú. | Đơn vị tiền: nghìn đồng |
...
Nội dung 1: declaration_date <= 04/04/2025; nội dung 2: sau ngày này. Không lọc ngày ghi nhận theo kỳ.
...
|---|---|---|---|
| POST | `/api/v1/reports/preview` | reportCode F-143 hoặc BCC_158 | `report:read` |
| POST | `/api/v1/reports/export` | Cùng bộ lọc preview; EXCEL/PDF/WORD (DOCX ảnh trang) | `report:read` |

## 7. Phần kỹ thuật — cấu trúc bảng

Nguồn: `infra_assets`. Không tạo bảng tổng hợp; đọc dữ liệu nghiệp vụ đã duyệt, loại bản ghi xóa mềm.
