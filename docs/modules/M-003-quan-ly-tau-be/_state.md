...
repo-path: .
project: ""
docs-path: docs/modules/M-003-quan-ly-tau-be
...
kpi:
  tokens-total: 0
  cycle-time-start: 2026-06-29T10:44:15Z
  tokens-by-stage: {}
  tokens-by-feature: {}
rework-count: {}
locked-fields: []
...
agent-flags: {}
feature-req: |
  file:docs/modules/M-003-quan-ly-tau-be/module-brief.md
...
|---|---|---|---|---|---|
| 1 | Intake | consulting-intelligence-extractor | Ready for BA | docs/intel/_snapshot.md | 2026-06-29T10:44:15Z |
...
**ba** — Ready to start. Input: `docs/modules/M-003-quan-ly-tau-be/module-brief.md`.
