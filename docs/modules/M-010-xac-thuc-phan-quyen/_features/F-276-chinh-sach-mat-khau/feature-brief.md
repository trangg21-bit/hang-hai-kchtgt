...
|---|---|---|---|
| BR-276-01 | Mật khẩu phải có tối thiểu 8 ký tự (configurable). Nếu dưới 8 ký tự → reject ngay với lỗi "Mật khẩu quá ngắn". | Đăng ký (F-271), Đổi mật khẩu (F-276), Đặt lại mật khẩu (F-274) | Chính sách bảo mật hệ thống |
