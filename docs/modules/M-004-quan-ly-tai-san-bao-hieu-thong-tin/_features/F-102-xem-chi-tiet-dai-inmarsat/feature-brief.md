...
🔴 `id` UUID PK, 🔴 `org_unit_id` UUID FK → `org_unit`, 🔴 `operating_org_id` UUID FK, 🔴 `code` VARCHAR(50) UNIQUE (tự sinh INMARSAT-{seq}), 🔴 `device_code` VARCHAR(50), 🔴 `name` VARCHAR(255) NOT NULL, 🔴 `station_name` VARCHAR(255), 🔴 `province_id` INTEGER NOT NULL, 🔴 `location_address` VARCHAR(1000) NOT NULL, 🔴 `location_detail` TEXT, 🔴 `condition_status` VARCHAR(50) DEFAULT 'OPERATIONAL', 🔴 `status` SMALLINT DEFAULT 0, 🔴 `coverage_zone` VARCHAR(1000), 🔴 `coverage_area` VARCHAR(1000), 🔴 `services` VARCHAR(1000) (multi-select JSON), 🔴 `frequency` VARCHAR(500), 🔴 `modem_type` VARCHAR(500), 🔴 `sar_code` VARCHAR(500), 🔴 `satellite_system` VARCHAR(500), 🔴 `notes` TEXT, 🔴 `description` VARCHAR(1000), 🔴 `contact_person` VARCHAR(500), 🔴 `contact_phone` VARCHAR(500), 🔴 `spatial_id` UUID, 🔴 `object_type` VARCHAR(50), 🔴 `symbol` VARCHAR(100), 🔴 `coordinate_system` VARCHAR(50) DEFAULT 'WGS84', 🔴 `display_rule` VARCHAR(500), 🔴 `latitude` DECIMAL(10,6), 🔴 `longitude` DECIMAL(10,6), 🔴 `security_level` SMALLINT DEFAULT 0, 🔴 `approval_status` SMALLINT DEFAULT 0, 🔴 `approval_level` SMALLINT, 🔴 `submitted_at` TIMESTAMP, 🔴 `submitted_by` UUID, 🔴 `approver_level1` UUID, 🔴 `approved_date_level1` TIMESTAMP, 🔴 `approver_level2` UUID, 🔴 `approved_date_level2` TIMESTAMP, 🔴 `rejection_reason` VARCHAR(1000), 🔴 `created_by` UUID, 🔴 `created_at` TIMESTAMP, 🔴 `updated_by` UUID, 🔴 `updated_at` TIMESTAMP, 🔴 `deleted_at` TIMESTAMP, 🔴 `deleted_by` UUID
