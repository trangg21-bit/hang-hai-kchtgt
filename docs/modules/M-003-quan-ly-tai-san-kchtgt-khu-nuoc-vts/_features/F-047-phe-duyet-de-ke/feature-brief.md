---
id: F-047
name: Phê duyệt Đê/kè
slug: phe-duyet-de-ke
module-id: M-003
status: proposed
...
consumed_by_modules: []
---
# Feature: Phê duyệt Đê/kè

## Description
Quy trình phê duyệt hai cấp cho các bản ghi đê/kè: trưởng phòng phê duyệt cấp 1 và cục trưởng phê duyệt cấp 2. Sau khi hoàn tất cả hai cấp phê duyệt, bản ghi đê/kè được đưa vào hệ thống chính thức và xuất hiện trong các báo cáo tổng hợp về công trình bảo vệ bờ.
...
## Out of Scope
- Quy trình tạo mới bản ghi (thuộc tính năng F-044)
- Cập nhật bản ghi sau phê duyệt (thuộc tính năng F-045)
...
## Entities
- **DeKe**: id, tenCongTrinh, viTri, loaiDeKe, chieuDai, namXayDung, vatLieu, dienTich, doUng, trangThai, pheDuyetC1, nguoiPheDuyetC1, ngayPheDuyetC1, pheDuyetC2, nguoiPheDuyetC2, ngayPheDuyetC2, lyDoTuChoi
- **PheDuyetLichSu**: id, deKeId, capPheDuyet, trangThai, nguoiPheDuyet, ngayPheDuyet, lyDo
