...
4. He thong luu du lieu voi trang thai = DRAFT (Luu tam)
5. Chuyen vien gui cho phe duyet → Ban ghi chuyen sang PENDING_APPROVAL (Cho Cang vu/Chi cuc duyet, cap 1)
6. Sau phe duyet C1 thanh cong → trang thai chuyen thanh APPROVED_LEVEL1 (Cho Cuc duyet)
7. Sau phe duyet C2 thanh cong → trang thai chuyen thanh APPROVED, chinh thuc ghi nhan

## Acceptance Criteria
- [x] Tao moi Luong hang hai thanh cong
- [x] Trang thai mac dinh = DRAFT (Luu tam) sau khi tao
...
| BR-038-02 | Trang thai mac dinh = DRAFT (Luu tam) sau khi tao | Create | DESIGN.md |
...
- Service tests: Create luong hang hai → validate → luu → tra ve DRAFT
