...
## Flow Summary
1. Chuyen vien tao moi hoac cap nhat co so sua chua, dong tau → he thong dat trang thai DRAFT (Lưu tạm)
...
| BR-053-02 | Phe duyet C1: PENDING_APPROVAL → APPROVED_LEVEL1 | Approve C1 | DESIGN.md |
| BR-053-03 | Phe duyet C2: APPROVED_LEVEL1 → APPROVED | Approve C2 | DESIGN.md |
...
| BR-053-06 | Khong duoc phe duyet cap 2 neu dang PENDING_APPROVAL | Approve | DESIGN.md |
