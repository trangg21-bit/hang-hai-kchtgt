...
- Hình học có bất kỳ đỉnh nào ngoài vùng bản đồ Việt Nam hoặc không hợp lệ thì không được chọn và không được vẽ; hệ thống phải cảnh báo để người dùng cập nhật lại tọa độ. Form CCTV phải chặn lưu mới/cập nhật cho đến khi nhập đủ tọa độ hợp lệ theo loại hình học.
