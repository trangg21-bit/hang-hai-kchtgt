...
- Bộ lọc loại KCHT phải trả về đầy đủ các bản ghi **Đã duyệt** thuộc phạm vi dữ liệu của người dùng, bao gồm Hệ thống SCADA; kết quả giữ đúng mã, tên, đơn vị quản lý, địa điểm, biểu tượng và hình học GIS đã đồng bộ.
