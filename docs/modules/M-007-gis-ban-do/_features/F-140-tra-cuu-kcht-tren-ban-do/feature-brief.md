...
- Bộ lọc loại KCHT phải trả về đầy đủ các bản ghi **Đã duyệt** thuộc phạm vi dữ liệu của người dùng cho toàn bộ 28 loại đã có nguồn dữ liệu quản lý, bao gồm Hệ thống SCADA, Hệ thống AIS, Hệ thống phụ trợ VTS, Hệ thống truyền dẫn và Trung tâm điều hành VTS; kết quả giữ đúng mã, tên, đơn vị quản lý, địa điểm, biểu tượng và hình học GIS đã đồng bộ.
- Hệ thống thông tin liên lạc VHF chưa có module/bảng dữ liệu quản lý nên không hiển thị trong bộ lọc tra cứu. Loại này chỉ được đưa vào tra cứu sau khi có nguồn dữ liệu nghiệp vụ và nhánh tổng hợp tương ứng.
...
- Khi mới mở màn hình, bộ lọc Đơn vị quản lý giữ giá trị "Tất cả đơn vị" như logic cũ và hệ thống tự tải danh sách KCHT thuộc phạm vi quyền của tài khoản. Sau khi Đặt lại, hệ thống khôi phục "Tất cả đơn vị" và tự tải lại danh sách. Quản lý lớp bản đồ mặc định chọn nền Google Map M, bật ENC, tắt QHCB; trong chi tiết ENC bật tất cả lớp trừ `OBSTRN` và `WRECKS`. Người dùng vẫn có thể bật/tắt từng lớp độc lập.
